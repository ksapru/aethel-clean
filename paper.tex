...
% References start on a fresh page so the 12-page content limit is
% unambiguous: the appendix ends on page 12 and the bibliography, which
% ECIR does not count toward the limit, begins on page 13.
\clearpage
